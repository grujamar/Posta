<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zahtev-izdavanje-pravno-lice-podnet.aspx.cs" Inherits="zahtev_izdavanje_pravno_lice_podnet" %>
                ...
                <div class="col-sm-8">
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 col-xxxl-4 margin-top-bottom">
                            <asp:HyperLink ID="btnContractLegalEntity" runat="server" download="" target="_blank" class="btn-lg btn-default submit" onclick="unhook();" Text=""/>
                        </div>
                        <div class="col-xs-12 col-lg-6 col-xxxl-4 margin-top-bottom margin-left-middle">
                            <asp:HyperLink ID="btnContractState" runat="server" download="" target="_blank" class="btn-lg btn-default submit" onclick="unhook();" Text=""/>
                        </div>
                        <div class="col-xs-12 col-lg-12 col-xxxl-4 margin-top-bottom margin-left-last">
                            <asp:HyperLink ID="btnContractAtachment" runat="server" download="" target="_blank" class="btn-lg btn-default submit" onclick="unhook();" Text=""/>
                        </div>
                    </div>                          
                </div>
                 <div class="col-sm-2 col-lg-none">
