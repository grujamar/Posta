            ...
            <div class="container-fluid" id="Container07" runat="server" style="margin-left: 10px">
                <div class="page-header" style="color:darkblue">
                    <h4><asp:Label id="lblnotification4" runat="server" style="font-size:19px;"></asp:Label></h4>
                        ...
                        <div class="row">                                 
                            <div class="col-sm-2" style="background-color:white;">
                                <asp:Label id="spanmaticnibroj" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblmaticnibroj" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>
                            </div>
                            <div class="col-sm-10" style="background-color:white;">
                        ...
                        <div class="row top10" id="rowLegalEntityName" runat="server">                                 
                            <div class="col-sm-2" style="background-color:white;">
                                <asp:Label id="spannazivpravnoglica" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblnazivpravnoglica" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                            </div>
                            <div class="col-sm-10" style="background-color:white;">
    ...
    <asp:UpdatePanel id="UpdatePanel4" runat="server">
      <ContentTemplate>
        ...
        <div class="container-fluid" id="Container10" runat="server" style="margin-left: 10px">
            ...
            <div class="row">
                    <div class="col-sm-2" style="background-color:white;">
                        <asp:Label id="spannacinpromene" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblnacinpromene" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                    </div>
                    <div class="col-sm-10" style="background-color:white;">
            ...
            <div class="container-fluid" id="Container08" runat="server" style="margin-left: 10px">
                            ...
                            <div class="row top10" id="Container11" runat="server" style="margin-left: 10px">
                                    <div class="col-sm-2" style="background-color:white;">
                                        <asp:Label id="spandatumgubitka" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lbldatumgubitka" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>
                                    </div>
                                    <div class="col-sm-10" style="background-color:white;">
                            ...
                            <div class="row top10" id="Container12" runat="server" style="margin-left: 10px">
                                    <div class="col-sm-2" style="background-color:white;">
                                        <asp:Label id="spandatumcompromise" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lbldatumcompromise" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>       
                                    </div>
                                    <div class="col-sm-10" style="background-color:white;">
                            ...
                            <div class="row top10" id="Container13" runat="server" style="margin-left: 10px">
                                    <div class="col-sm-2" style="background-color:white;">
                                        <asp:Label id="spandrugo" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lbldrugo" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>
                                    </div>
                                    <div class="col-sm-10" style="background-color:white;">
                ...
                <div class="container-fluid" id="Container09" runat="server" style="margin-left: 10px">
                    ...
                    <div class="row top10">                                 
                        <div class="col-sm-2" style="background-color:white;">
                            <asp:Label id="spanostalo" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblostalo" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                        </div>
                        <div class="col-sm-10" style="background-color:white;">
