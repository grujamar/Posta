...
public partial class zahtev_izdavanje_pravno_lice_podnet : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Session["zahtev-izdavanje-pravno-lice-brojzahteva"] != null)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "requestsend();", true);
                txtbrojzahteva.Text = Session["zahtev-izdavanje-pravno-lice-brojzahteva"].ToString();
                txtdatumzahteva.Text = Session["zahtev-izdavanje-pravno-lice-datumzahteva"].ToString();
                txtcenasaporezom.Text = Session["zahtev-izdavanje-pravno-lice-cenasaporezom"].ToString();

                string NavigateUrlContractLegalEntity = Utils.ConvertToTildaPath(Session["zahtev-izdavanje-pravno-lice-filename1"].ToString());
                btnContractLegalEntity.NavigateUrl = @NavigateUrlContractLegalEntity;
                string NavigateUrlContractState = Utils.ConvertToTildaPath(Session["zahtev-izdavanje-pravno-lice-filename2"].ToString());
                ...
                try
                {
                    string activityCode = utility.getItemTextActivityCode(Session["zahtev-izdavanje-pravno-lice-sifradel"].ToString(), Constants.ACTIVITY_CODE_TRUE);
            ...
            {
                Response.Redirect("zahtev-izdavanje-pravno-lice.aspx", false); // this will tell .NET framework not to stop the execution of the current thread and hence the error will be resolved.
            }
        }
    }
    ...
    protected void btnContractLegalEntity_Click(object sender, EventArgs e)
    {
        ...
        {
            /*
            string pdfContractLegalEntity = Session["zahtev-izdavanje-pravno-lice-filename1"].ToString();
            ...
            */
            ...
            Utils.DownloadPDF(page, Session["zahtev-izdavanje-pravno-lice-filename1"].ToString());
        }
        catch (Exception ex)
        {
    ...
    protected void btnContractState_Click(object sender, EventArgs e)
    {
        ...
        {
            /*
            string pdfContractGovernment = Session["zahtev-izdavanje-pravno-lice-filename2"].ToString();
            Response.ContentType = "Application/pdf";
            ...
            */
            Page page = (Page)HttpContext.Current.Handler;
            Utils.DownloadPDF(page, Session["zahtev-izdavanje-pravno-lice-filename2"].ToString());
        }
        catch (Exception ex)
        {
    ...
    protected void btnContractAtachment_Click(object sender, EventArgs e)
    {
        ...
        {
            /*
            string pdfContractAtachment = Session["zahtev-izdavanje-pravno-lice-filename"].ToString();
            Response.ContentType = "Application/pdf";
            ...
            */
            Page page = (Page)HttpContext.Current.Handler;
            Utils.DownloadPDF(page, Session["zahtev-izdavanje-pravno-lice-filename"].ToString());
        }
        catch (Exception ex)
        {
