<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zahtev-izdavanje-pravno-lice-stranac-bez-JMBG.aspx.cs" Inherits="zahtev_izdavanje_pravno_lice_stranac_bez_JMBG" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid top10">
                ...
                <asp:HyperLink id="pdfhyperlink1" runat="server" NavigateUrl="~/dokumentacija/Uputstvo-izdavanje-pravno-lice-stranac-bez-JMBG.pdf" target="_blank" style="vertical-align:bottom" TabIndex="-1"><asp:Label id="lblkorisniskouputstvo" runat="server" style="font-size:15px;"></asp:Label></asp:HyperLink>
        </div>
        <div class="row">
        </div>
            <!-------------------------------------------OVO SE NE VIDI------------------------------------------------>
                ...
                <fieldset>
                        <div class="row top10">                                 
                                    <div class="col-sm-2" style="background-color:white;">
                                        <asp:Label id="spanidentificationnumber" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblidentificationnumber" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>  
                                    </div>
                        ...
                        <div class="row top10" id="rowLegalEntityName" runat="server">                                 
                                    <div class="col-sm-2" style="background-color:white;">
                                        <asp:Label id="spanlegalname" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lbllegalname" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>  
                                    </div>
                                    <div class="col-sm-10" style="background-color:white;">
            ...
            <asp:UpdatePanel id="UpdatePanel30" runat="server">
                <ContentTemplate>
                    <fieldset>
                        <div class="row top10">                                 
                                    <div class="col-sm-2" style="background-color:white;">
                                        <asp:Label id="spanpib" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblpib" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                                    </div>
                                    <div class="col-sm-10" style="background-color:white;">
                                        <asp:TextBox ID="txtpib" runat="server" class="txtbox2" style="font-size:13px;" maxlength="9" ontextchanged="txtpib_TextChanged" OnClientClick="return CheckIfChannelHasChanged2();" AutoPostBack="true" onkeyup="change(this,'btnAddAuthorizedPersonalUser');" onkeydown="keydownFunctionPIB(); return true;" TabIndex="0"></asp:TextBox>
            ...
            <asp:UpdatePanel id="UpdatePanel1" runat="server">
              <ContentTemplate>
                <fieldset>
                    <div class="row top10">
                                <div class="col-sm-2" style="background-color:white;">
                                    <asp:Label id="spanpdvpayer" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblpdvpayer" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>
                                </div>
                                <div class="col-sm-10" style="background-color:white;">
                                    ...
                                    <asp:ObjectDataSource ID="odsObveznikPDV" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetItemByPageAndControl" TypeName="RABackTableAdapters.ItemTableAdapter">
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="zahtev-izdavanje-pravno-lice-stranac-bez-JMBG.aspx" Name="filename" Type="String" />
                    ...
                    <div class="row top10">                                 
                                <div class="col-sm-2" style="background-color:white;">
                                    <asp:Label id="spanbtc" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblbtc" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>
                                </div>
                                <div class="col-sm-10" style="background-color:white;">
            ...
            <asp:UpdatePanel id="UpdatePanel15" runat="server">
                <ContentTemplate>
                    <fieldset>            
                        <div class="row top10">                                 
                                    <div class="col-sm-2" style="background-color:white;">
                                        <asp:Label id="spankontakttel" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblkontakttel" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                                    </div>
                                    <div class="col-sm-10" style="background-color:white;">
            ...
            <asp:UpdatePanel id="UpdatePanel17" runat="server">
                <ContentTemplate>
                    <fieldset>
                        <div class="row top10">                                 
                                    <div class="col-sm-2" style="background-color:white;">
                                        <asp:Label id="spanwebadresa" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblwebadresa" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                                    </div>
                                    <div class="col-sm-10" style="background-color:white;">
                                        ...
                                        <asp:CustomValidator runat="server" id="cvwebadresa" controltovalidate="txtwebadresa" OnServerValidate="cvwebadresa_ServerValidate" errormessage="" Display="Dynamic" ForeColor="Red" style="font-size:13px;" ValidateEmptyText="true"/>
                                    </div>
                        </div>
                     </fieldset>
                </ContentTemplate>
            ...
            <asp:UpdatePanel id="UpdatePanel3" runat="server">
                <ContentTemplate>
                    <fieldset>
                        ...
                        <div class="row top10">                                 
                                <div class="col-sm-2" style="background-color:white;">
                                    <asp:Label id="spanimezz" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblimezz" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                                </div>
                                <div class="col-sm-10" style="background-color:white;">
                        ...
                        <div class="row top10">                                 
                                <div class="col-sm-2" style="background-color:white;">
                                    <asp:Label id="spanprezimezz" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblprezimezz" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                                </div>
                                <div class="col-sm-10" style="background-color:white;">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="PAK" runat="server" Value='<%# Eval("PAK") %>'  />
        ...
        <div class="container-fluid" id="myDiv6" runat="server" style="margin-left: 10px; background-color:#f5f5f5;">
            <div class="row top20">
                        ...
                        <div class="col-sm-10">
                            <asp:Button ID="btnEnterRequest" runat="server" class="btn btn-primary save" Text="" OnClick="btnEnterRequest_Click2" onclientclick="unhook()" ValidationGroup="EnabledValidation"/>
                            <asp:Button ID="btnReEnterRequest" runat="server" class="btn btn-warning edit" Text="" OnClick="btnReEnterRequest_Click2" onclientclick="unhook()" ValidationGroup="EnabledValidation"/>
                        </div>
                        <div class="col-sm-2">
                            ...
                            <asp:UpdatePanel id="UpdatePanel7" runat="server">
                              <ContentTemplate>
                                 <fieldset>
                                        ...
                                        <div class="row top10">                                 
                                              <div class="col-sm-2" style="background-color:white;">
                                                  <asp:Label id="spanadresaeposte1" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lbladresaeposte1" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                                              </div>
                                              <div class="col-sm-10" style="background-color:white;">
                                    ...
                                    <div class="row top10">
                                              <div class="col-sm-2" style="background-color:white;">
                                               ...
                                               <div class="col-sm-10" style="background-color:white;">
                                                    ...
                                                    <br><p class="notification" style="margin-right: 10px; margin-bottom: 3px;"><asp:Label id="lblnotification8" runat="server"></asp:Label></p>
                                               </div>  
                                    </div>
                                 </fieldset>
                              </ContentTemplate>
                                      ...
                                      <fieldset>
                                        <div class="row top10">
                                                    ...
                                                    <div class="col-sm-10" style="background-color:white;">
                                                        ...
                                                        <br><p class="notification"><asp:Label id="lblnotification9" runat="server"></asp:Label></p>
                                                    </div>
                                        </div>
                                        <div class="row top15">                                 
                                                    <div class="col-sm-2" style="background-color:white;">
                                                        <asp:Label id="spanmesto1" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblmesto1" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                                                    </div>
                                                    <div class="col-sm-10" style="background-color:white;">
                                        ...
                                        <div class="row top10">                                 
                                                    <div class="col-sm-2" style="background-color:white;">
                                                        <asp:Label id="spanulica1" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblulica1" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label> 
                                                    </div>
                                                    <div class="col-sm-10" style="background-color:white;">
                            ...
                            <asp:UpdatePanel id="UpdatePanel20" runat="server">
                                <ContentTemplate>
                                    <fieldset>
                                        <div class="row top10">                                 
                                                    <div class="col-sm-2" style="background-color:white;">
                                                        <asp:Label id="spanbroj1" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblbroj1" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>  
                                                    </div>
                                                    <div class="col-sm-10" style="background-color:white;">
                            ...
                            <asp:UpdatePanel id="UpdatePanel21" runat="server">
                                <ContentTemplate> 
                                      <fieldset>
                                        <div class="row top10">
                                                    <div class="col-sm-2" style="background-color:white;">
                                                        <asp:Label id="spanpostanskibroj1" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblpostanskibroj1" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>
                                                    </div>
                                                    <div class="col-sm-10" style="background-color:white;">
                                                        ...
                                                        <asp:CustomValidator runat="server" id="cvpostanskibroj1" controltovalidate="txtpostanskibroj1" OnServerValidate="cvpostanskibroj1_ServerValidate" errormessage="" Display="Dynamic" ForeColor="Red" style="font-size:13px;" ValidateEmptyText="true"/>
                                                    </div>
                                        </div>
                                        <div class="row top10">
                                                    <div class="col-sm-2" style="background-color:white;">
                                                       <asp:Label id="spanpak1" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblpak1" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>
                                                    </div>
                                                    <div class="col-sm-10" style="background-color:white;">
                            ...
                            <asp:UpdatePanel id="UpdatePanel14" runat="server">
                                <ContentTemplate>
                                    <fieldset>
                                        <div class="row top10">                                 
                                                    <div class="col-sm-2" style="background-color:white;">
                                                        <asp:Label id="spancenasaporezom1" runat="server" style="COLOR: red; font-weight:bold; font-size:17px;"></asp:Label>&nbsp;<asp:Label id="lblcenasaporezom1" runat="server" style="font-weight:bold;font-size:13px;"> </asp:Label>  
                                                    </div>
                                                    <div class="col-sm-10" style="background-color:white;">
                                                        <asp:TextBox ID="txtcenasaporezom1" runat="server" readonly="true" class="txtbox1" style="border:solid grey 1px; padding: 3px; text-align: right; height: 26px; width: !important;" TabIndex="-1"></asp:TextBox>
                ...
                <!-------------------------------------------------------------------------------------------------------------------------------------->    
                        ...
                        <div class="container-fluid" id="Div3" runat="server" style="margin-left: 10px; background-color:#f5f5f5;">
                                    <div class="row top20">
                                                ...
                                                <div class="col-sm-8">
                                                    <asp:Button ID="btnBack" runat="server" class="btn btn-warning arrowLeft" Text="" onclick="btnBack_Click3" onclientclick="unhook()" Width="150px"/>                            
                                                </div>
                                                <div class="col-sm-2">
                        ...
                        <div class="container-fluid" id="Div4" runat="server" style="margin-left: 10px; background-color:#f5f5f5;">
                                    <div class="row top20">
                                                <div class="col-sm-2">
